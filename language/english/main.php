...
define("_SnX_MS_KEYWORDS", "Keywords");
define("_SnX_MS_SEARCH", "Search");
define("_SnX_MS_RESULTS", "We have found <b>%d</b> results for <b>%s</b> (%s seconds)");
define("_SnX_MS_GLOBAL", "World Web");
