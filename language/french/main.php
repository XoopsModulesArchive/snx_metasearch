...
define("_SnX_MS_KEYWORDS", "Mots cl&eacute;s");
define("_SnX_MS_SEARCH", "Recherche");
define("_SnX_MS_RESULTS", "<b>%d</b> r&eacute;sultats pour <b>%s</b> (%s sec.)");
define("_SnX_MS_GLOBAL", "Web mondial");
define("_SnX_MS_FRENCH", "Web fran&ccedil;ais");
define("_SnX_MS_LOCAL", $_SERVER['HTTP_HOST']);
