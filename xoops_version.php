...
$modversion['name'] = "SnX-Metasearch";
$modversion['version'] = "0.4";
$modversion['description'] = _SnX_MS_DESC;
...
$modversion['dirname'] = "snx_metasearch";
...
$modversion['blocks'][1]['name'] = "SnX MetaSearch";
$modversion['blocks'][1]['show_func'] = "disp_ms_block";
$modversion['blocks'][1]['description'] = "SnX MetaSearch";
